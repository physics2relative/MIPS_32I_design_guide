...
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| add, addu | 1 | DEST_RD(01) | A_RS(00) | B_RT(000) | IMM_NONE(111) | X/BR_EQ(0) | ALU_ADD(0000) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| sub, subu | 1 | DEST_RD(01) | A_RS(00) | B_RT(000) | IMM_NONE(111) | X/BR_EQ(0) | ALU_SUB(0001) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| and | 1 | DEST_RD(01) | A_RS(00) | B_RT(000) | IMM_NONE(111) | X/BR_EQ(0) | ALU_AND(0010) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| or | 1 | DEST_RD(01) | A_RS(00) | B_RT(000) | IMM_NONE(111) | X/BR_EQ(0) | ALU_OR(0011) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| xor | 1 | DEST_RD(01) | A_RS(00) | B_RT(000) | IMM_NONE(111) | X/BR_EQ(0) | ALU_XOR(0100) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| nor | 1 | DEST_RD(01) | A_RS(00) | B_RT(000) | IMM_NONE(111) | X/BR_EQ(0) | ALU_NOR(1010) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| slt | 1 | DEST_RD(01) | A_RS(00) | B_RT(000) | IMM_NONE(111) | X/BR_EQ(0) | ALU_SLT(0101) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| sltu | 1 | DEST_RD(01) | A_RS(00) | B_RT(000) | IMM_NONE(111) | X/BR_EQ(0) | ALU_SLTU(0110) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |

##### 6.2 Shift

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | Branch | Jump | JumpSel | PCSel |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| sll | 1 | DEST_RD(01) | A_RT(11) | B_SHAMT(011) | IMM_NONE(111) | X/BR_EQ(0) | ALU_SLL(0111) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| srl | 1 | DEST_RD(01) | A_RT(11) | B_SHAMT(011) | IMM_NONE(111) | X/BR_EQ(0) | ALU_SRL(1000) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| sra | 1 | DEST_RD(01) | A_RT(11) | B_SHAMT(011) | IMM_NONE(111) | X/BR_EQ(0) | ALU_SRA(1001) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| sllv | 1 | DEST_RD(01) | A_RT(11) | B_RS_LOW5(100) | IMM_NONE(111) | X/BR_EQ(0) | ALU_SLL(0111) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| srlv | 1 | DEST_RD(01) | A_RT(11) | B_RS_LOW5(100) | IMM_NONE(111) | X/BR_EQ(0) | ALU_SRL(1000) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| srav | 1 | DEST_RD(01) | A_RT(11) | B_RS_LOW5(100) | IMM_NONE(111) | X/BR_EQ(0) | ALU_SRA(1001) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |

##### 6.3 I-type ALU / Immediate

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | Branch | Jump | JumpSel | PCSel |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| addi, addiu | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_ADD(0000) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| andi | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_ZERO16(001) | X/BR_EQ(0) | ALU_AND(0010) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| ori | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_ZERO16(001) | X/BR_EQ(0) | ALU_OR(0011) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| xori | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_ZERO16(001) | X/BR_EQ(0) | ALU_XOR(0100) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| slti | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_SLT(0101) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| sltiu | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_SLTU(0110) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |
| lui | 1 | DEST_RT(00) | A_ZERO(10) | B_IMM(001) | IMM_LUI16(010) | X/BR_EQ(0) | ALU_ADD(0000) | WB_ALU(01) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 0 | X | PC_PLUS4(00) |

##### 6.4 Load

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | Branch | Jump | JumpSel | PCSel |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| lb | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_ADD(0000) | WB_MEM(00) | MEM_BYTE(00) | MEM_LOAD(011) | 0 | 0 | 0 | X | PC_PLUS4(00) |
| lbu | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_ADD(0000) | WB_MEM(00) | MEM_BYTE(00) | MEM_LOAD(011) | 1 | 0 | 0 | X | PC_PLUS4(00) |
| lh | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_ADD(0000) | WB_MEM(00) | MEM_HALF(01) | MEM_LOAD(011) | 0 | 0 | 0 | X | PC_PLUS4(00) |
| lhu | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_ADD(0000) | WB_MEM(00) | MEM_HALF(01) | MEM_LOAD(011) | 1 | 0 | 0 | X | PC_PLUS4(00) |
| lw | 1 | DEST_RT(00) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_ADD(0000) | WB_MEM(00) | MEM_WORD(10) | MEM_LOAD(011) | X | 0 | 0 | X | PC_PLUS4(00) |

##### 6.5 Store

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | Branch | Jump | JumpSel | PCSel |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| sb | 0 | DEST_NONE(11) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_ADD(0000) | WB_NONE(11) | MEM_BYTE(00) | MEM_SB(000) | X | 0 | 0 | X | PC_PLUS4(00) |
| sh | 0 | DEST_NONE(11) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_ADD(0000) | WB_NONE(11) | MEM_HALF(01) | MEM_SH(001) | X | 0 | 0 | X | PC_PLUS4(00) |
| sw | 0 | DEST_NONE(11) | A_RS(00) | B_IMM(001) | IMM_SIGN16(000) | X/BR_EQ(0) | ALU_ADD(0000) | WB_NONE(11) | MEM_WORD(10) | MEM_SW(010) | X | 0 | 0 | X | PC_PLUS4(00) |

##### 6.6 Branch

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | Branch | Jump | JumpSel | PCSel |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| beq | 0 | DEST_NONE(11) | A_PC4(01) | B_BR_OFFSET(010) | IMM_BRANCH16(011) | BR_EQ(0) | ALU_ADD(0000) | WB_NONE(11) | MEM_NONE(11) | MEM_IDLE(100) | X | 1 | 0 | X | BrTaken ? PC_BRANCH(01) : PC_PLUS4(00) |
| bne | 0 | DEST_NONE(11) | A_PC4(01) | B_BR_OFFSET(010) | IMM_BRANCH16(011) | BR_NE(1) | ALU_ADD(0000) | WB_NONE(11) | MEM_NONE(11) | MEM_IDLE(100) | X | 1 | 0 | X | BrTaken ? PC_BRANCH(01) : PC_PLUS4(00) |
...
| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | Branch | Jump | JumpSel | PCSel |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| j | 0 | DEST_NONE(11) | A_ZERO(10) | B_NONE(111) | IMM_J26(100) | X/BR_EQ(0) | ALU_NONE(1111) | WB_NONE(11) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 1 | JUMP_IMM26(0) | PC_JUMP(10) |
| jal | 1 | DEST_RA(10) | A_ZERO(10) | B_NONE(111) | IMM_J26(100) | X/BR_EQ(0) | ALU_NONE(1111) | WB_PC4(10) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 1 | JUMP_IMM26(0) | PC_JUMP(10) |
| jr | 0 | DEST_NONE(11) | A_RS(00) | B_NONE(111) | IMM_NONE(111) | X/BR_EQ(0) | ALU_NONE(1111) | WB_NONE(11) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 1 | JUMP_REG(1) | PC_JUMP(10) |
| jalr | 1 | DEST_RD(01) | A_RS(00) | B_NONE(111) | IMM_NONE(111) | X/BR_EQ(0) | ALU_NONE(1111) | WB_PC4(10) | MEM_NONE(11) | MEM_IDLE(100) | X | 0 | 1 | JUMP_REG(1) | PC_JUMP(10) |
...
| 신호 | 폭 | 설명 |
| --- | ---: | --- |
| `ImmSel` | 3 | ID 단계 Imm Generator의 즉시값 생성 방식 선택입니다. `ImmSel` 자체는 ID에서 소비하고, EX 단계에는 생성된 `ImmExt`, `BranchOff`, `JumpTarget` 값을 전달합니다. |
...
| `ALUSel` | 4 | ALU operation 선택입니다. |
| `JumpSel` | 2 | 점프 대상 source 선택입니다. ID 단계에서 생성된 jump target 후보 중 immediate/register source를 고릅니다. |
...
| --- | --- |
| ID/EX | RegWEn, DestSel, WBSel, ASel, BSel, BrSel, ALUSel, JumpSel, Branch, Jump, WdLen, MemRW, LoadEx, `ImmExt`, `BranchOff`, `JumpTarget` |
| EX/MEM | RegWEn, WBSel, WdLen, MemRW, LoadEx, 확정된 WriteReg |
| MEM/WB | RegWEn, WBSel, 확정된 WriteReg |

`ImmSel`은 ID 단계 Imm Generator가 소비하므로 `ID/EX`로 전달하지 않습니다. EX 단계로 넘어가야 하는 것은 `ImmSel`이 아니라 생성된 `ImmExt`, `BranchOff`, `JumpTarget` 값입니다.
...
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| add | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_ADD | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| addu | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_ADD | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| sub | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_SUB | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| subu | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_SUB | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| and | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_AND | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| or | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_OR | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| xor | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_XOR | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| nor | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_NOR | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| slt | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_SLT | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| sltu | 1 | DEST_RD | A_RS | B_RT | IMM_NONE | X/BR_EQ | ALU_SLTU | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |

##### 7.2 Shift

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | JumpSel | Branch | Jump | RsUsed | RtUsed |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| sll | 1 | DEST_RD | A_RT | B_SHAMT | IMM_NONE | X/BR_EQ | ALU_SLL | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 0 | 1 |
| srl | 1 | DEST_RD | A_RT | B_SHAMT | IMM_NONE | X/BR_EQ | ALU_SRL | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 0 | 1 |
| sra | 1 | DEST_RD | A_RT | B_SHAMT | IMM_NONE | X/BR_EQ | ALU_SRA | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 0 | 1 |
| sllv | 1 | DEST_RD | A_RT | B_RS_LOW5 | IMM_NONE | X/BR_EQ | ALU_SLL | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| srlv | 1 | DEST_RD | A_RT | B_RS_LOW5 | IMM_NONE | X/BR_EQ | ALU_SRL | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| srav | 1 | DEST_RD | A_RT | B_RS_LOW5 | IMM_NONE | X/BR_EQ | ALU_SRA | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 1 |

##### 7.3 I-type ALU / Immediate

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | JumpSel | Branch | Jump | RsUsed | RtUsed |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| addi | 1 | DEST_RT | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 0 |
| addiu | 1 | DEST_RT | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 0 |
| andi | 1 | DEST_RT | A_RS | B_IMM | IMM_ZERO16 | X/BR_EQ | ALU_AND | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 0 |
| ori | 1 | DEST_RT | A_RS | B_IMM | IMM_ZERO16 | X/BR_EQ | ALU_OR | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 0 |
| xori | 1 | DEST_RT | A_RS | B_IMM | IMM_ZERO16 | X/BR_EQ | ALU_XOR | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 0 |
| slti | 1 | DEST_RT | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_SLT | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 0 |
| sltiu | 1 | DEST_RT | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_SLTU | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 1 | 0 |
| lui | 1 | DEST_RT | A_ZERO | B_IMM | IMM_LUI16 | X/BR_EQ | ALU_ADD | WB_ALU | MEM_NONE | MEM_IDLE | X | JUMP_NONE | 0 | 0 | 0 | 0 |

##### 7.4 Load

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | JumpSel | Branch | Jump | RsUsed | RtUsed |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| lb | 1 | DEST_RT | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_MEM | MEM_BYTE | MEM_LOAD | 0 | JUMP_NONE | 0 | 0 | 1 | 0 |
| lbu | 1 | DEST_RT | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_MEM | MEM_BYTE | MEM_LOAD | 1 | JUMP_NONE | 0 | 0 | 1 | 0 |
| lh | 1 | DEST_RT | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_MEM | MEM_HALF | MEM_LOAD | 0 | JUMP_NONE | 0 | 0 | 1 | 0 |
| lhu | 1 | DEST_RT | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_MEM | MEM_HALF | MEM_LOAD | 1 | JUMP_NONE | 0 | 0 | 1 | 0 |
| lw | 1 | DEST_RT | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_MEM | MEM_WORD | MEM_LOAD | X | JUMP_NONE | 0 | 0 | 1 | 0 |

##### 7.5 Store

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | JumpSel | Branch | Jump | RsUsed | RtUsed |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| sb | 0 | DEST_NONE | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_NONE | MEM_BYTE | MEM_SB | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| sh | 0 | DEST_NONE | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_NONE | MEM_HALF | MEM_SH | X | JUMP_NONE | 0 | 0 | 1 | 1 |
| sw | 0 | DEST_NONE | A_RS | B_IMM | IMM_SIGN16 | X/BR_EQ | ALU_ADD | WB_NONE | MEM_WORD | MEM_SW | X | JUMP_NONE | 0 | 0 | 1 | 1 |
...
Branch target은 EX 단계에서 `PC+4 + (sign_ext(imm16) << 2)`로 계산합니다. Branch compare 조건은 ALU result/zero flag 대신 별도 `BranchComp`가 `FwdRsData`, `FwdRtData`, 1-bit `BrSel`을 보고 판단합니다. `Branch` enable은 PCControl/NextPC에서 별도로 gating합니다. 이 분리 때문에 branch용 ALU flag forwarding을 추가하지 않아도 되고, branch operand forwarding은 `BranchComp` 입력으로 직접 들어갑니다.

##### 7.7 Jump / Link

| 명령어 | RegWEn | DestSel | ASel | BSel | ImmSel | BrSel | ALUSel | WBSel | WdLen | MemRW | LoadEx | JumpSel | Branch | Jump | RsUsed | RtUsed |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| j | 0 | DEST_NONE | A_ZERO | B_NONE | IMM_J26 | X/BR_EQ | ALU_NONE | WB_NONE | MEM_NONE | MEM_IDLE | X | JUMP_IMM26 | 0 | 1 | 0 | 0 |
| jal | 1 | DEST_RA | A_ZERO | B_NONE | IMM_J26 | X/BR_EQ | ALU_NONE | WB_PC4 | MEM_NONE | MEM_IDLE | X | JUMP_IMM26 | 0 | 1 | 0 | 0 |
| jr | 0 | DEST_NONE | A_RS | B_NONE | IMM_NONE | X/BR_EQ | ALU_NONE | WB_NONE | MEM_NONE | MEM_IDLE | X | JUMP_REG | 0 | 1 | 1 | 0 |
| jalr | 1 | DEST_RD | A_RS | B_NONE | IMM_NONE | X/BR_EQ | ALU_NONE | WB_PC4 | MEM_NONE | MEM_IDLE | X | JUMP_REG | 0 | 1 | 1 | 0 |
...
```text
BranchCond  = BranchComp(FwdRsData, FwdRtData, BrSel)  // BrSel: 0=EQ, 1=NE
BranchTaken = Branch && BranchCond                       // Branch enable은 BranchComp 밖에서 적용
...
`Branch`는 opcode decode에서 생성하고, `Jump`는 `JumpSel != JUMP_NONE`에서 파생해도 됩니다. `BrSel`은 1-bit EQ/NE 선택이므로 branch 여부 판정에 사용하지 않습니다.
