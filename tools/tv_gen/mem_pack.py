...
SCHEMAS: Dict[str, Sequence[Field]] = {
    ...
    "control_unit": (("opcode_bin", 6), ("funct_bin", 6), ("RegWEn", 1), ("DestSel", 2), ("ASel", 2), ("BSel", 3), ("ImmSel", 2), ("BrSel", 1), ("ALUSel", 4), ("WBSel", 2), ("WdLen", 2), ("MemRW", 2), ("LoadEx", 1), ("Branch", 1), ("Jump", 1), ("JumpSel", 1)),
    "data_memory": (("InitialWord", 32), ("Addr", 32), ("Data_rt", 32), ("WdLen_bin", 2), ("MemRW_bin", 2), ("LoadEx", 1), ("Expected_Lane", 2), ("Expected_WE", 4), ("Expected_MisalignedAccess", 1), ("Expected_Data_RD", 32), ("ExpectedNewWord", 32)),
    "imm_generator": (("ImmSel_bin", 2), ("imm16", 16), ("Expected_ImmVal", 32)),
    "jump_target": (("PCPlus4", 32), ("target26", 26), ("Expected_JumpImmTarget", 32)),
